package org.walkerljl.boss.service.v1.collect.check.storer.support;
        ...
        Runtime.getRuntime().addShutdownHook(new Thread() {
            ...
            public void run() {
                try {
                    ...
                    //                    TraceUtils.traceExceptionQuietly(getServiceName() + " do shutdownhook task occurs error, skip
                    // and continue.",
                    //                            new Object[]{buffer}, e);
                }
            }
